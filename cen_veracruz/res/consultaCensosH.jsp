        ...
        <td width="418"><table width="1081" border="0">
          ...
          <tr>
            ...
            <td class="style33"><strong>
              <label><strong>
                <textarea name="txtf_1" cols="40" class="form-control" id="txtf_1" onkeypress="return handleEnter(this, event);" readonly="readonly"></textarea>
              </strong></label>
              </strong></td>
            <td width="1">&nbsp;</td>
            ...
            <td><span class="style49">
              <label></label>
              <label>
                <input name="txtf_3" type="text" class="form-control" id="txtf_3" onkeypress="return handleEnter(this, event);" value="<%=d5%>" readonly="readonly"/>
                </label>
              </span></td>
            </tr>
          <tr>
            ...
            <td><span class="style49">
              <label></label>
              <label>
                <input name="txtf_4" type="text" class="form-control" id="txtf_4" onkeypress="return handleEnter(this, event);" value="<%=d5%>" readonly="readonly"/>
                </label>
              </span></td>
            </tr>
          <tr>
            ...
            <td class="style33"><strong>
              <label>
                <textarea name="txtf_3" cols="40" class="form-control" id="txtf_3" onkeypress="return handleEnter(this, event);" readonly="readonly"><%=a3%></textarea>
                </label>
              </strong></td>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td class="style33"><strong>
              <label>
                <textarea name="txtf_4" cols="40" class="form-control" id="txtf_4" onkeypress="return handleEnter(this, event);" readonly="readonly"><%=a4%></textarea>
                </label>
              </strong></td>
            <td>&nbsp;</td>
